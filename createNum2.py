...
model = YOLO(task="detect",model="./runs/detect/train10/weights/best.pt")
...
for img_path in img_file_list:
    ...
    # ******* YOLO v8 ********
    ObjectDetection_results = model.predict(img,project="runs2",name="predict",exist_ok=False,conf=0.5,save=True)
    # ******* YOLO v8 ********
